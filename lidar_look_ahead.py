...
class HallwayCenterNode(Node):
    ...
    def __init__(self):
        ...
        self.angle_tol = math.radians(10)   # wall angle considered "parallel"
        self.perp_tol = math.radians(10)    # wall angle considered "perpendicular"
    ...
    def _pd_steering(self, ranges_np: np.ndarray, msg: LaserScan,
        ...
        right_angle = self._wall_angle_right(ranges_np, msg, math.pi / 2, self.side_half_cone)
    ...
    def scan_callback(self, msg: LaserScan):
        ...
        now       = time.time()
        front_min = self._valid_min(ranges,  msg, 180, self.front_half_cone)
        ...
        if self.mode == self.MODE_TURN:
            right_angle = self._wall_angle_right(ranges, msg, math.pi / 2, self.side_half_cone)
            parallel = (
