...
#include "custom_messages/msg/detail/latency_stats__rosidl_typesupport_fastrtps_c.h"
...
using _LatencyStats__ros_msg_type = custom_messages__msg__LatencyStats;
...
size_t get_serialized_size_custom_messages__msg__LatencyStats(
  const void * untyped_ros_message,
...
static uint32_t _LatencyStats__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_custom_messages__msg__LatencyStats(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_custom_messages
size_t max_serialized_size_custom_messages__msg__LatencyStats(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = custom_messages__msg__LatencyStats;
    is_plain =
      (
...
static size_t _LatencyStats__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_custom_messages__msg__LatencyStats(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, custom_messages, msg, LatencyStats)() {
