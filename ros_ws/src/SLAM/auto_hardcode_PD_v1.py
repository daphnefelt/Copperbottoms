...
def pose_goal_from_hallway(hallway):
    pose_map = {
        ...
        2: 100,  # left hallway, face up
        3: -80, # right hallway, face down
    }
...
class Hardcoded(Node):
    def __init__(self):
        ...
        # side-wall avoidance
        self.side_threshold = 0.75  # m — start skewing away when either side is closer than this
        self.kp_side = 0.3
    ...
    def _scan_cb(self, msg: LaserScan):
        ...
        self.right_dist = self._cone_min(msg, math.radians(-90.0), math.radians(35.0))
        self.left_dist  = self._cone_min(msg, math.radians( 90.0), math.radians(35.0))
