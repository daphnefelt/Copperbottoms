...
```bash
ros2 launch /path/to/ros_ws/src/SLAM/SLAM_dependency_launch.py
```

**Terminal 2 — Nav2 + waypoint navigation:**
```bash
ros2 launch /path/to/ros_ws/src/SLAM/waypoint_nav/waypoint_nav_launch.py
```
...
| File | Purpose |
|------|---------|
| `waypoint_nav_launch.py` | Main launch file for Nav2 + bridges |
