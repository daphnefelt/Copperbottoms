...
class HallwayCenterNode(Node):
    ...
    def __init__(self):
        ...
        self.clear_dis       = 0.5   # must exceed this to resume centering (m)
        ...
        self.deadband_frac   = 0.1   # 0.1 = middle 20% of hallway is dead
    ...
    def scan_callback(self, msg: LaserScan):
        ...
        # Subtract deadband from error so command ramps smoothly from zero
        # at the zone edge. Inside the zone, corrected error is 0 -> straight.
        if error > deadband:
